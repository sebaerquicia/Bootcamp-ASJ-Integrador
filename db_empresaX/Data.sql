...
VALUES
    (1, 1, 'Juan', 'Pérez', 123456789, 'juan.perez@gmail.com', GETDATE(), GETDATE()),
    (2, 2, 'Ana', 'Gómez', 987654321, 'ana.gomez@hotmail.com', GETDATE(), GETDATE()),
    (3, 3, 'Carlos', 'Rodríguez', 456789012, 'carlos.rodriguez@gmail.com', GETDATE(), GETDATE()),
    (4, 4, 'Luisa', 'Martínez', 789012345, 'luisa.martinez@gmail.com', GETDATE(), GETDATE()),
    (5, 5, 'Pedro', 'Fernández', 234567890, 'pedro.fernandez@hotmail.com', GETDATE(), GETDATE()),
    (6, 1, 'María', 'López', 351678901, 'maria.lopez@gmail.com', GETDATE(), GETDATE()),
    (7, 2, 'Martín', 'Sánchez', 3516789013, 'martin.sanchez@gmail.com', GETDATE(), GETDATE()),
    (8, 3, 'Sofía', 'Díaz', 678901234, 'sofia.diaz@hotmail.com', GETDATE(), GETDATE()),
    (9, 4, 'Eduardo', 'Ramírez', 890123456, 'eduardo.ramirez@hotmail.com', GETDATE(), GETDATE()),
    (10, 5, 'Laura', 'Gutiérrez', 901234567, 'laura.gutierrez@hotmail.com', GETDATE(), GETDATE());
...
VALUES
    ...
    (6, 7, 'SKU011', 'Papas Grandes', 'Papas tamaño xl', '', 3500, GETDATE(), GETDATE()),
